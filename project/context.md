...
- **Languages**: python: 146, shell: 3, go: 1
- **Analysis Mode**: static
- **Total Functions**: 1176
- **Total Classes**: 137
- **Modules**: 150
- **Entry Points**: 834
...
### Flow 10: compute_file_metrics
```
compute_file_metrics [code2llm.exporters.toon.metrics_core.CoreMetricsComputer]
  └─ →> _is_excluded
```
