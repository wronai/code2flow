...
## Powód (z analizy DFG)
- Function 'analyze_communities' has high complexity: fan-out=10, mutations=0.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/optimization/advanced_optimizer.py (linie 40-60)
