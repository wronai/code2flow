...
## Powód (z analizy DFG)
- Function 'visualize_call_graph' has high complexity: fan-out=21, mutations=11.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/visualizers/graph.py (linie 114-134)
