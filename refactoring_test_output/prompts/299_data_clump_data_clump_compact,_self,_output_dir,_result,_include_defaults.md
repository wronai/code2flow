## Cel refaktoryzacji
Extract logic from `compact, self, output_dir, result, include_defaults` to a new method/function.

## Powód (z analizy DFG)
- Arguments (compact, self, output_dir, result, include_defaults) are used together in multiple functions: code2flow.exporters.base.YAMLExporter.export_split, code2flow.exporters.base.export_split.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/exporters/base.py (linie 89-109)
