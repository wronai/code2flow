...
## Powód (z analizy DFG)
- Function '_summarize_functions' has high complexity: fan-out=21, mutations=18.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/llm_flow_generator.py (linie 211-231)
