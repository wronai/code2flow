## Cel refaktoryzacji
Extract logic from `lines, file_path, self, class_name, result, module_name, node` to a new method/function.

## Powód (z analizy DFG)
- Arguments (lines, file_path, self, class_name, result, module_name, node) are used together in multiple functions: code2flow.core.analyzer.FileAnalyzer._process_function, code2flow.core.analyzer._process_function.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/core/analyzer.py (linie 236-256)
