## Cel refaktoryzacji
Extract logic from `nodes` to a new method/function.

## Powód (z analizy DFG)
- Mutation of variable 'nodes' spans 6 functions. Changing this logic requires work in many places.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/cli.py (linie 161-181)
