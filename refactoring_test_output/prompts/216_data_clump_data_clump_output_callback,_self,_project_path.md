## Cel refaktoryzacji
Extract logic from `output_callback, self, project_path` to a new method/function.

## Powód (z analizy DFG)
- Arguments (output_callback, self, project_path) are used together in multiple functions: code2flow.core.streaming_analyzer.StreamingAnalyzer.analyze_streaming, code2flow.core.streaming_analyzer.analyze_streaming.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/core/streaming_analyzer.py (linie 294-314)
