...
## Powód (z analizy DFG)
- Function '_identify_process_patterns' has high complexity: fan-out=10, mutations=0.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/exporters/base.py (linie 747-767)
