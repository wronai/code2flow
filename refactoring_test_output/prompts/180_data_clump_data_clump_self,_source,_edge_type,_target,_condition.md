## Cel refaktoryzacji
Extract logic from `self, source, edge_type, target, condition` to a new method/function.

## Powód (z analizy DFG)
- Arguments (self, source, edge_type, target, condition) are used together in multiple functions: code2flow.extractors.cfg_extractor.CFGExtractor.connect, code2flow.extractors.cfg_extractor.connect, code2flow.analysis.cfg.CFGExtractor.connect, code2flow.analysis.cfg.connect.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/extractors/cfg_extractor.py (linie 57-77)
