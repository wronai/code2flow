## Cel refaktoryzacji
Extract logic from `self.result.data_flows[scoped_name].dependencies` to a new method/function.

## Powód (z analizy DFG)
- Mutation of variable 'self.result.data_flows[scoped_name].dependencies' spans 6 functions. Changing this logic requires work in many places.
- Fan-out: 
- Mutacje: 
