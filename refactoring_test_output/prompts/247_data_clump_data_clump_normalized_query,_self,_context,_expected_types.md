## Cel refaktoryzacji
Extract logic from `normalized_query, self, context, expected_types` to a new method/function.

## Powód (z analizy DFG)
- Arguments (normalized_query, self, context, expected_types) are used together in multiple functions: code2flow.nlp.pipeline.NLPPipeline._step_resolve_entities, code2flow.nlp.pipeline._step_resolve_entities.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/nlp/pipeline.py (linie 220-240)
