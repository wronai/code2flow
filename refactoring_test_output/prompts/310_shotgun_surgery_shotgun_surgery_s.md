## Cel refaktoryzacji
Extract logic from `s` to a new method/function.

## Powód (z analizy DFG)
- Mutation of variable 's' spans 5 functions. Changing this logic requires work in many places.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/mermaid_generator.py (linie 32-52)
