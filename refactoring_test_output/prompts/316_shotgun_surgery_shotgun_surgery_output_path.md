## Cel refaktoryzacji
Extract logic from `output_path` to a new method/function.

## Powód (z analizy DFG)
- Mutation of variable 'output_path' spans 7 functions. Changing this logic requires work in many places.
- Fan-out: 
- Mutacje: 
