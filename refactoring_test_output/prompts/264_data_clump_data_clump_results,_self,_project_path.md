## Cel refaktoryzacji
Extract logic from `results, self, project_path` to a new method/function.

## Powód (z analizy DFG)
- Arguments (results, self, project_path) are used together in multiple functions: code2flow.core.analyzer.ProjectAnalyzer._merge_results, code2flow.core.analyzer._merge_results.
- Fan-out: 
- Mutacje: 
