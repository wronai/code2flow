## Cel refaktoryzacji
Extract logic from `_find_data_dependencies` to a new method/function.

## Powód (z analizy DFG)
- Function '_find_data_dependencies' has high complexity: fan-out=6, mutations=11.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/exporters/base.py (linie 463-483)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji _find_data_dependencies. Skup się na wydzieleniu operacji o największej liczbie mutacji.