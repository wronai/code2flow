...
## Powód (z analizy DFG)
- Function 'analyze_type_patterns' has high complexity: fan-out=7, mutations=6.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/optimization/advanced_optimizer.py (linie 115-135)
