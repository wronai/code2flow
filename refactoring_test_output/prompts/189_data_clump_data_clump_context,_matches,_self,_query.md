## Cel refaktoryzacji
Extract logic from `context, matches, self, query` to a new method/function.

## Powód (z analizy DFG)
- Arguments (context, matches, self, query) are used together in multiple functions: code2flow.nlp.intent_matching.IntentMatcher._apply_context, code2flow.nlp.intent_matching._apply_context.
- Fan-out: 
- Mutacje: 
