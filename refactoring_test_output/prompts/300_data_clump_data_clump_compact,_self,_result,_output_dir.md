## Cel refaktoryzacji
Extract logic from `compact, self, result, output_dir` to a new method/function.

## Powód (z analizy DFG)
- Arguments (compact, self, result, output_dir) are used together in multiple functions: code2flow.exporters.base.YAMLExporter.export_separated, code2flow.exporters.base.export_separated.
- Fan-out: 
- Mutacje: 
