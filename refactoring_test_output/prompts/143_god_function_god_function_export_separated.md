## Cel refaktoryzacji
Extract logic from `export_separated` to a new method/function.

## Powód (z analizy DFG)
- Function 'export_separated' has high complexity: fan-out=21, mutations=33.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/exporters/base.py (linie 191-211)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji export_separated. Skup się na wydzieleniu operacji o największej liczbie mutacji.