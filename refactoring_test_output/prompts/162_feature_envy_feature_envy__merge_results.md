...
## Powód (z analizy DFG)
- Function '_merge_results' mutates multiple variables in other modules: merged.classes, merged.functions, merged.data_flows, merged.edges, merged.nodes, merged.mutations.
- Feature Envy: Accesses more data from `merged` than `analyzer`.
- Foreign Mutatons: merged.classes, merged.functions, merged.data_flows, merged.edges, merged.nodes, merged.mutations
...
## Instrukcja
Przenieś metodę _merge_results do modułu, który posiada większość używanych w niej danych.