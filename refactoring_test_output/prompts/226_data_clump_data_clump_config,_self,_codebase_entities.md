## Cel refaktoryzacji
Extract logic from `config, self, codebase_entities` to a new method/function.

## Powód (z analizy DFG)
- Arguments (config, self, codebase_entities) are used together in multiple functions: code2flow.nlp.entity_resolution.EntityResolver.__init__, code2flow.nlp.entity_resolution.__init__.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/nlp/entity_resolution.py (linie 53-73)
