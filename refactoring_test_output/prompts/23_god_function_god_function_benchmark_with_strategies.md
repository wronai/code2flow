...
## Powód (z analizy DFG)
- Function 'benchmark_with_strategies' has high complexity: fan-out=6, mutations=11.
- Fan-out: 
- Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/benchmarks/benchmark_performance.py (linie 132-152)
