## Cel refaktoryzacji
Extract logic from `context, self, expected_types, query` to a new method/function.

## Powód (z analizy DFG)
- Arguments (context, self, expected_types, query) are used together in multiple functions: code2flow.nlp.entity_resolution.EntityResolver.resolve, code2flow.nlp.entity_resolution.resolve.
- Fan-out: 
- Mutacje: 
