## Cel refaktoryzacji
Extract logic from `func_info` to a new method/function.

## Powód (Głęboka Analiza)
- Mutation of variable 'func_info' spans 9 functions. Changing this logic requires work in many places.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/analysis/cfg.py (linie 69+)
