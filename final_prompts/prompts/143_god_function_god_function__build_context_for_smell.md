...
- Function '_build_context_for_smell' is highly complex: CC=1, fan-out=14, mutations=0.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/refactor/prompt_engine.py (linie 78+)
