## Cel refaktoryzacji
Move method `total, start_time, processed, self` from module `streaming_analyzer` to `other_module`.

## Powód (Głęboka Analiza)
- Arguments (total, start_time, processed, self) are used together in multiple functions: code2flow.core.streaming_analyzer.StreamingAnalyzer._estimate_eta, code2flow.core.streaming_analyzer._estimate_eta.
