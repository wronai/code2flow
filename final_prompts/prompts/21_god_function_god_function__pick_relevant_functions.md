...
- Function '_pick_relevant_functions' is highly complex: CC=8, fan-out=9, mutations=6.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/llm_flow_generator.py (linie 149+)
