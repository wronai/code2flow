## Cel refaktoryzacji
Extract logic from `prioritize_files` to a new method/function.

## Powód (Głęboka Analiza)
- Function 'prioritize_files' is highly complex: CC=1, fan-out=14, mutations=21.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/core/streaming_analyzer.py (linie 161+)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji prioritize_files. Skup się na wydzieleniu operacji o największej liczbie mutacji.