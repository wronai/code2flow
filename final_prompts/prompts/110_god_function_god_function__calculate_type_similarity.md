## Cel refaktoryzacji
Extract logic from `_calculate_type_similarity` to a new method/function.

## Powód (Głęboka Analiza)
- Function '_calculate_type_similarity' is highly complex: CC=1, fan-out=4, mutations=6.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/optimization/advanced_optimizer.py (linie 280+)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji _calculate_type_similarity. Skup się na wydzieleniu operacji o największej liczbie mutacji.