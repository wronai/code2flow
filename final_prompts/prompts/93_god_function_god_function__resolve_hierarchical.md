...
- Function '_resolve_hierarchical' is highly complex: CC=1, fan-out=3, mutations=7.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/nlp/entity_resolution.py (linie 205+)
