## Cel refaktoryzacji
Extract logic from `short_name` to a new method/function.

## Powód (Głęboka Analiza)
- Mutation of variable 'short_name' spans 5 functions. Changing this logic requires work in many places.
