...
- Function 'create_test_project' is highly complex: CC=5, fan-out=8, mutations=24.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/benchmarks/benchmark_performance.py (linie 24+)
