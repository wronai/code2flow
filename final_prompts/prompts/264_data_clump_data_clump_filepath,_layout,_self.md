## Cel refaktoryzacji
Move method `filepath, layout, self` from module `graph` to `other_module`.

## Powód (Głęboka Analiza)
- Arguments (filepath, layout, self) are used together in multiple functions: code2flow.visualizers.graph.GraphVisualizer.visualize_cfg, code2flow.visualizers.graph.visualize_cfg.
- Status reachability: unknown
- Feature Envy: Metoda używa więcej danych z `other_module` niż z `graph`.
- Obce Mutacje: 
...
## Dotknięte pliki
- /home/tom/github/wronai/code2flow/code2flow/visualizers/graph.py — źródło
-  — cel
