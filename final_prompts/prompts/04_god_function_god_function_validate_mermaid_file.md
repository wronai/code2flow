## Cel refaktoryzacji
Extract logic from `validate_mermaid_file` to a new method/function.

## Powód (Głęboka Analiza)
- Function 'validate_mermaid_file' is highly complex: CC=42, fan-out=20, mutations=22.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/mermaid_generator.py (linie 15+)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji validate_mermaid_file. Skup się na wydzieleniu operacji o największej liczbie mutacji.