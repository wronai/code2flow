## Cel refaktoryzacji
Move method `name, query, self` from module `entity_resolution` to `other_module`.

## Powód (Głęboka Analiza)
- Arguments (name, query, self) are used together in multiple functions: code2flow.nlp.entity_resolution.EntityResolver._name_similarity, code2flow.nlp.entity_resolution._name_similarity.
