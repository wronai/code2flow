...
- Function 'visit_FunctionDef' is highly complex: CC=1, fan-out=7, mutations=13.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/extractors/cfg_extractor.py (linie 69+)
