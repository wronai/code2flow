...
- Mutation of variable 'smells' spans 7 functions. Changing this logic requires work in many places.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/analysis/smells.py (linie 51+)
