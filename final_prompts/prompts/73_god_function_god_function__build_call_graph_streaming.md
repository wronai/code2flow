## Cel refaktoryzacji
Extract logic from `_build_call_graph_streaming` to a new method/function.

## Powód (Głęboka Analiza)
- Function '_build_call_graph_streaming' is highly complex: CC=1, fan-out=5, mutations=8.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/core/streaming_analyzer.py (linie 487+)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji _build_call_graph_streaming. Skup się na wydzieleniu operacji o największej liczbie mutacji.