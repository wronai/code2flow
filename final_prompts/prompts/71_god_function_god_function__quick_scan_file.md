...
- Function '_quick_scan_file' is highly complex: CC=1, fan-out=15, mutations=19.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/core/streaming_analyzer.py (linie 383+)
