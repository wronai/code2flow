## Cel refaktoryzacji
Extract logic from `content` to a new method/function.

## Powód (Głęboka Analiza)
- Mutation of variable 'content' spans 9 functions. Changing this logic requires work in many places.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/core/streaming_analyzer.py (linie 630+)
