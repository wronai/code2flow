## Cel refaktoryzacji
Move method `exit, depth, body, max_depth, result, self, func_name, entry` from module `analyzer` to `other_module`.

## Powód (Głęboka Analiza)
- Arguments (exit, depth, body, max_depth, result, self, func_name, entry) are used together in multiple functions: code2flow.core.analyzer.FileAnalyzer._process_cfg_block, code2flow.core.analyzer._process_cfg_block.
