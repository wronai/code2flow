...
- Function 'load_from_analysis' mutates multiple variables in other modules: self.codebase_entities['module'], self.codebase_entities['class'], self.codebase_entities['function'].
- Status reachability: unknown
- Feature Envy: Metoda używa więcej danych z `self` niż z `entity_resolution`.
- Obce Mutacje: self.codebase_entities['module'], self.codebase_entities['class'], self.codebase_entities['function']
...
## Instrukcja
Przenieś metodę load_from_analysis do modułu, który posiada większość używanych w niej danych. Zmniejsz coupling między modułami.