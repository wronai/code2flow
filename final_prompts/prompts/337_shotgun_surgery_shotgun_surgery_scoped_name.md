## Cel refaktoryzacji
Extract logic from `scoped_name` to a new method/function.

## Powód (Głęboka Analiza)
- Mutation of variable 'scoped_name' spans 6 functions. Changing this logic requires work in many places.
