...
- Feature Envy: Metoda używa więcej danych z `func_info` niż z `analyzer`.
- Obce Mutacje: func_info.calls, self.stats['functions_found'], result['module'].functions

## Kontekst strukturalny
- Zależności: 
- Mutacje w module docelowym: This code mutates state in result['module'], func_info, self
...
## Instrukcja
Przenieś metodę _process_function do modułu, który posiada większość używanych w niej danych. Zmniejsz coupling między modułami.