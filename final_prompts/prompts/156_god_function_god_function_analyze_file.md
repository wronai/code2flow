## Cel refaktoryzacji
Extract logic from `analyze_file` to a new method/function.

## Powód (Głęboka Analiza)
- Function 'analyze_file' is highly complex: CC=1, fan-out=7, mutations=12.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/core/analyzer.py (linie 137+)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji analyze_file. Skup się na wydzieleniu operacji o największej liczbie mutacji.