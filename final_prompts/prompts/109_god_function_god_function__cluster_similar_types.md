...
- Function '_cluster_similar_types' is highly complex: CC=1, fan-out=7, mutations=8.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/optimization/advanced_optimizer.py (linie 252+)
