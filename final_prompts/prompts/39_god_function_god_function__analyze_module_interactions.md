...
- Function '_analyze_module_interactions' is highly complex: CC=1, fan-out=7, mutations=6.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/analysis/coupling.py (linie 21+)
