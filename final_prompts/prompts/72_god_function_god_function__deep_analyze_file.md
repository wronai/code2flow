...
- Function '_deep_analyze_file' is highly complex: CC=1, fan-out=4, mutations=8.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/core/streaming_analyzer.py (linie 456+)
