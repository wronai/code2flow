## Cel refaktoryzacji
Extract logic from `_trace_flow` to a new method/function.

## Powód (Głęboka Analiza)
- Function '_trace_flow' is highly complex: CC=1, fan-out=15, mutations=19.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/exporters/base.py (linie 1159+)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji _trace_flow. Skup się na wydzieleniu operacji o największej liczbie mutacji.