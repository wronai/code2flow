## Cel refaktoryzacji
Extract logic from `_find_data_pipelines` to a new method/function.

## Powód (Głęboka Analiza)
- Function '_find_data_pipelines' is highly complex: CC=1, fan-out=8, mutations=12.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/exporters/base.py (linie 381+)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji _find_data_pipelines. Skup się na wydzieleniu operacji o największej liczbie mutacji.