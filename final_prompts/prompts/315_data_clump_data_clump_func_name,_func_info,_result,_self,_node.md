## Cel refaktoryzacji
Move method `func_name, func_info, result, self, node` from module `analyzer` to `other_module`.

## Powód (Głęboka Analiza)
- Arguments (func_name, func_info, result, self, node) are used together in multiple functions: code2flow.core.analyzer.FileAnalyzer._build_cfg, code2flow.core.analyzer._build_cfg.
