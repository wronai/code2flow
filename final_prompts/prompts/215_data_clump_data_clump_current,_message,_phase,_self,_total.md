## Cel refaktoryzacji
Move method `current, message, phase, self, total` from module `streaming_analyzer` to `other_module`.

## Powód (Głęboka Analiza)
- Arguments (current, message, phase, self, total) are used together in multiple functions: code2flow.core.streaming_analyzer.StreamingAnalyzer._report_progress, code2flow.core.streaming_analyzer._report_progress.
