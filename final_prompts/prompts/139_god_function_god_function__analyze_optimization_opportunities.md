...
- Function '_analyze_optimization_opportunities' is highly complex: CC=1, fan-out=8, mutations=19.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/exporters/base.py (linie 791+)
