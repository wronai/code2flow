## Cel refaktoryzacji
Extract logic from `_process_cfg_block` to a new method/function.

## Powód (Głęboka Analiza)
- Function '_process_cfg_block' is highly complex: CC=1, fan-out=6, mutations=26.
...
## Plik i Zakres
- /home/tom/github/wronai/code2flow/code2flow/core/analyzer.py (linie 336+)
...
## Instrukcja
Wyekstrahuj mniejsze, spójne metody z funkcji _process_cfg_block. Skup się na wydzieleniu operacji o największej liczbie mutacji.